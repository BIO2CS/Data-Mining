...
public class ATTMCL {
    ...
    static String file1 = "/home/huiqiong/Desktop/attweb_net.txt";
    ...
    public static void writeCluster(double[][] matrix, String inputFile, int numberOfNodes) {
        ...
        try{
            ...
            for(i = 0; i < numberOfNodes; i++){
                ...
                for(j = 0; j < integerClusters.size(); j++){
                    ArrayList<Integer> list = integerClusters.get(j);
                    if(list.contains(d)){
            ...
            for(i = 0; i < integerClusters.size(); i++){
                ArrayList<Integer> list = integerClusters.get(i);
            ...
            System.out.println("FINAL integer cluster size " + integerClusters.size());
            bw.close();
        }
        catch(IOException e){
            // TODO Auto-generated catch block
    ...
    public static double[][] MCLAlgorithm(Graph g, int numberOfNodes){
        ...
        while(true){
            counter++;
            // expand by taking the square power of the normalized matrix
            ...
            expandedMatrix = inflation(expandedMatrix, 1.35);
